...
function linkAction() {
  ...
  // Reset the icon to hamburger and remove rotate animation
...
sr.reveal(".card", { distance: "20px", origin: "top", duration: 2000, interval: 200});
...
const scriptURL =
  "https://script.google.com/macros/s/AKfycbyPtTHfGTxIGeyHWCkO05ammq6cdyXlzOFnI20HRB2lVzwZCAe_Y3QQIkt_MRd0Pt-53A/exec";
